...
try {
    $query_guarda_tabela_aluno = $pdo -> prepare("UPDATE aluno 
        SET nome = :nome, 
        sobrenome = :sobrenome,
    ...
    /*
    $query_pega_cod_aluno = $pdo-> query("SELECT cod_aluno FROM aluno WHERE ra = '$ra';");
    $query_pega_cod_aluno = $query_pega_cod_aluno -> fetchAll(PDO::FETCH_ASSOC);
    $cod_aluno = $query_pega_cod_aluno[0]['cod_aluno'];
    
    if ($TAA001 == 1) {
        $query_disc_matriculada = $pdo -> prepare("UPDATE disc_matriculada SET cod_disc = :cod_disc, cod_aluno = :cod_aluno, status_matricula = '1' WHERE ra = '$ra'");
        ...
        $query_disc_matriculada = $pdo -> prepare("INSERT INTO disc_matriculada SET cod_disc = '1', cod_aluno = :cod_aluno, status_matricula = '0' WHERE ra = '$ra'");
    ...
    if ($TAA002 == "2") {
        $query_disc_matriculada = $pdo -> prepare("INSERT INTO disc_matriculada SET cod_disc = :cod_disc, cod_aluno = :cod_aluno, status_matricula = '1' WHERE ra = '$ra'");

        $query_disc_matriculada -> bindValue(":cod_disc", "$TAA002");
        $query_disc_matriculada -> bindValue(":cod_aluno", "$cod_aluno");
        $query_disc_matriculada -> execute();
    } else {
        $query_disc_matriculada = $pdo -> prepare("INSERT INTO disc_matriculada SET cod_disc = '2', cod_aluno = :cod_aluno, status_matricula = '0' WHERE ra = '$ra'");
    ...
    */
    ...
    header('Location: editar-alunos.php');

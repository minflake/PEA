...
<head>
  ...
  <title>Atribuir Conceitos</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../gerenciar-conceitos/atribuir-conceito.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.php">Gerenciar Conceitos</a></li>
          <li class="breadcrumb-item active">Atribuir Conceitos</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

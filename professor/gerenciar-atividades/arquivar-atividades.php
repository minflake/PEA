...
<head>
  ...
  <title>Arquivar Atividades</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="arquivar-atividades.php" class="active">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Arquivar Atividades</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
          <li class="breadcrumb-item"><a href="index.php">Gerenciar Atividades</a></li>
          <li class="breadcrumb-item active">Arquivar Atividades</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

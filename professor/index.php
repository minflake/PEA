      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
              ...
              <div class="card info-card sales-card">
                <a href="prazos/index.php">
                  <div class="card-body">
                    ...
                    <div class="card-text">
                      <p>
                        Parametrize os prazos limites para o semestre vigente.
                      </p>
                    </div>
                  </div>
                </a>
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card sales-card">
                <a href="cadastrar-regulamento/index.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Inserir Regulamento</h5>
                      </div>
                    </div>
                    
                    <div class="card-text">
                      <p>
                        Cadastre, edite, vizualize ou exclua o Regulamento Geral.
                      </p>
                    </div>
                  </div>
                </a>
              ...
              <div class="card info-card sales-card">
                <a href="gerenciar-alunos/index.php">
                  <div class="card-body">
                    ...
                    <div class="card-text">
                      <p>
                        Cadastre, edite, visualize ou exclua os dados de alunos.
                      </p>
                    </div>
                  </div>
                </a>
              ...
              <div class="card info-card sales-card">
                <a href="gerenciar-atividades/index.php">
                  <div class="card-body">
                    ...
                    <div class="card-text">
                      <p>
                        Cadastre, edite, vizualize, exclua ou arquive uma atividade a ser feita.
                      </p>
                    </div>
                  </div>
                </a>
                ...
                <a href="gerenciar-relatorios/index.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Gerenciar Devolutivas</h5>
                      </div>
                    </div>
                    
                    <div class="card-text">
                      <p>
                        Vizualize os relatórios enviados e/ou atribua feedbacks.
                      </p>
                    </div>
                  </div>
                </a>
              ...
              <div class="card info-card sales-card">
                <a href="gerenciar-conceitos/index.php">
                  <div class="card-body">
                    ...
                    <div class="card-text">
                      <p>
                        Atribua, edite ou vizualize os conceitos finais  dos relatórios.
                      </p>
                    </div>
                  </div>
                </a>

    ...
    if (!in_array($extensao, $extensoes_permitidas)) {
        ...
        if (move_uploaded_file($caminho_temporario, $diretorio_destino . $nome_arquivo)) {
            ...
            try {
                ...
                $query = $pdo->prepare("INSERT INTO arquivos SET cod_usuario = '" . $_SESSION["cod_usuario"] . "', nome_arquivo_original = :nome_arquivo_original, nome_arquivo = '$nome_arquivo', extensao = '" . $anexo["type"] . "', tamanho = '" . $anexo["size"] . "',caminho_arquivo = '$caminho_completo';");

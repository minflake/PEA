    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.php">
              <i class="bi bi-circle"></i><span>Pesquisar Alunos</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="forms-editors.php">
              <i class="bi bi-circle"></i><span>Cadastrar Aluno</span>
            </a>
          </li>
          <li>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.php">
              <i class="bi bi-circle"></i><span>Pesquisar Atividades</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-file-earmark-text"></i><span>Gerenciar Relatórios</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="icons-bootstrap.php">
              <i class="bi bi-circle"></i><span>Pesquisar Relatório</span>
            </a>
          </li>
          <li>
            <a href="icons-remix.php">
              <i class="bi bi-circle"></i><span>Vizualizar Relatório</span>
            </a>
          </li>
          <li>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
                ...
                <a href="cadastrar-prazos.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Gerenciar Prazos</h5>
                      </div>
                    </div>
                ...
                <a href="cadastrar-prazos.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Cadastrar Regulamento</h5>
                      </div>
                    </div>
                ...
                <a href="cadastrar-prazos.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Gerenciar Atividades</h5>
                      </div>
                    </div>
            ...
            </div><!-- FIM CARD GERENCIAR ATIVIDADES -->

            <!-- CARD GERENCIAR RELATORIOS -->
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card sales-card">
                <a href="cadastrar-prazos.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Gerenciar Relatórios</h5>
                      </div>
                    </div>
            ...
            </div><!-- FIM CARD GERENCIAR RELATÓRIOS -->

            <!-- CARD GERENCIAR CONCEITOS -->
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card sales-card">
                <a href="cadastrar-prazos.php">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h5 class="card-title">Gerenciar Conceitos</h5>
                      </div>
                    </div>
            ...
            </div><!-- FIM CARD GERENCIAR CONCEITOS -->

                    ...
                    <div class="card">
                        <div class="card-body pt-3 justify-content-center">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered justify-content-center">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" disabled>Foto de Perfil</button>
                                </li>
                            ...
                            <div class="tab-content pt-2 justify-content-center">

                                <div class="tab-pane fade show active profile-overview justify-content-center text-center" id="profile-overview">
                                    <h5 class="card-title">Envie uma foto de perfil!</h5>
                                    <form class="row justify-content-center" action="processa-primeiro-acesso.php" method="post" enctype="multipart/form-data">
                                        <div class="col-5">
                                            <input type="file" id="filepond" class="filepond" name="filepond" accept="image/png, image/jpeg">
                                        </div>
                                        <div class="row justify-content-center">
        ...
        ?>
                    <div class="row justify-content-center">
                        <div class="col-12 d-flex justify-content-center alerts-settings">
                            <div class="alert alert-danger alert-dismissible fade show " role="alert">
                                Erro ao enviar a foto. Tente novamnte ou contate o administrador.
                ...
                ?>
                    <div class="row justify-content-center">
                        <div class="col-12 d-flex justify-content-center alerts-settings">
                            <div class="alert alert-danger alert-dismissible fade show " role="alert">
                                Formato de imagem invalido! Por favor, envie apenas .jpeg, .jpg ou .png.
                                <button type="button" class="btn-close" data-bs-dismiss="alert" echo aria-label="Close"></button>
                            </div>
                        </div>
                    </div>

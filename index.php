...
if ($contar_registros_adm = count($res_verificar_adm) == 0) {
    $novo_adm = $pdo->query("INSERT INTO usuario SET senha = '$senha', status_usuario = '1', perfil = 'ADM'");
    var_dump($novo_adm);
    if ($novo_adm) {
                ...
                <div class="row justify-content-center">
                    <div class="col-12 d-flex justify-content-center alerts-settings">
                        <div class="alert alert-danger alert-dismissible fade show text-center" role="alert">
                            Usuário ou senha incorretos!<br>Tente novamente ou contate o administrador.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" echo aria-label="Close"></button>
                        </div>
                    </div>
                </div>

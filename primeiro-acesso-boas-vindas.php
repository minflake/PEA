                    ...
                    <div class="card">
                        <div class="card-body pt-3 justify-content-center">
                            ...
                            <div class="tab-content pt-2 justify-content-center text-center">
                                <h5 class="card-title">Boas vindas, <?php echo $_SESSION["dados_usuario"][0]["nome"]; ?>!</h5>
                                <p>
                                    Tudo pronto, agora você já pode usar o PEA!
                                </p>

                                <div class="d-grid gap-2 mt-3">
                                    <form action="processa-primeiro-acesso.php" method="get">
                                        <input type="number" value="1" name="primeiro_acesso" hidden>
                                        <button class="btn btn-primary" type="submit">Acessar a página inicial</button>
                                    </form>
                                </div>
                            </div>
                        </div>
